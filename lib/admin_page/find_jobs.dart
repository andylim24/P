...
class Page2Admin extends StatefulWidget {
  const Page2Admin({super.key});

  @override
  State<Page2Admin> createState() => _Page2AdminState();
}

class _Page2AdminState extends State<Page2Admin> {
    ...
    return TableRow(
      children: [
        ...
        Padding(
          ...
          child: Text(value ?? 'N/A', style: const TextStyle(fontSize: 14), softWrap: true),
        ),
      ],
    );
  }
                                                    ...
                                                    children: [
                                                      ElevatedButton(
                                                        ...
                                                        style: ElevatedButton.styleFrom(
                                                          backgroundColor:
                                                          alreadyApplied ? Colors.grey : Colors.red.shade700,
